...
def recommendation():
    ...
    b = open("C:/Users/s4538443/PycharmProjects/untitled/tfidf/Training Results/user_corpus.txt", "r")
    for us_line in b:
        ...
        def track_split():
            global rated_tracks, unrated_tracks
            tem_tracks = []
            c = open("C:/Users/s4538443/PycharmProjects/untitled/tfidf/Training Results/train.txt", "r")
            for dl_line in c:
            ...
            d = open("C:/Users/s4538443/PycharmProjects/untitled/tfidf/Training Results/similarity.txt", "r")
            for rs_line in d:
        ...
        for j in range(len(unrated_tracks)):
            ...
            for k in range(len(rated_tracks)):
                ...
                m = open("C:/Users/s4538443/PycharmProjects/untitled/tfidf/Training Results/similarity.txt", "r")
                for is_line in m:
                    if unrated_tracks[j] in is_line.strip().split("|") and rated_tracks[k] in is_line.strip().split("|"):
                        sim_ij = float(is_line.strip().split("|")[2])
                m.close()

                n = open("C:/Users/s4538443/PycharmProjects/untitled/tfidf/Training Results/train.txt", "r")
                for adl_line in n:
            ...
            if denominator != 0:
                ...
                if prediction > 0:
                    def prediction_output():
                        pr = open("C:/Users/s4538443/PycharmProjects/untitled/tfidf/Training Results/tf_idf_prediction.txt", "a+")
